...
<>    <div className="footer">
    ...
    <li><Link to="/contact" className="footer-link">Contact</Link></li>
      ...
      <div className="foot3">
          ...
          <div className="footer-social-links">
            ...
            <li><a href="https://www.instagram.com/the_homemade_wonders/" target="_blank" rel="noopener noreferrer" className="footer-link">
 ...
 <div className="copyright">
  <p>Door No: 16-1-30/A/7 ,Lokayukta Colony ,Saidabad, Hyderabad, India - 500059 </p>
