...
const Home = () => {
  ...
  const settings = {
    ...
    infinite: true,
    speed: 500,
    slidesToShow: 4, // Show 4 products at a time, adjust as needed
    slidesToScroll: 1,
    ...
    <h2 className="text-xl font-bold mt-5">Special Offers</h2>
      <div className="carousel-container">
        ...
        <FaAngleRight
          ...
          onClick={() => {
            if (currentSlide < deals.length - settings.slidesToShow) {
              setCurrentSlide(currentSlide + 1);
            }
          }}
        />
            ...
            <div className="col-md-3" key={product.id}>
              <div className="product-card" style={productCardStyle}>
                ...
                <div className='myproducts'>
                  {product.productCost ? (
                    <p style={{ textDecoration: 'line-through', color: 'red', fontSize: '30px' }}>{` ${product.productCost}`}</p>
                  ) : (
