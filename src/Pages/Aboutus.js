...
function Aboutus() {
  return (
    <div>
        ...
        <h1 style={{marginTop: '30px', marginBottom: '30px', fontFamily: 'sans-serif'}}>About us</h1>
      <img src='/assests/main.jpeg' height="auto" width="auto"  className='img-fluid'></img>
      

      <div className='row mt-5'>
         <div className='col-4 text-center'>
            <h1>Craft is a Theraphy</h1>
            </div>
    ...
    <div className='col-6'>
      ...
      <button type="button" className="btn btn-lg btn-success">
        <Link to="/home" style={{color: 'white'}}>  <i class="fa-solid fa-cart-shopping"></i>  Shop Now</Link>
